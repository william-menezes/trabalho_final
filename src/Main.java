...
public class Main {
    public static void main(String[] args) {
        ...
        gerentes[0] = new Gerente("72282256632", "Mariana Oliveira", LocalDate.parse("1990-02-03"), EstadoCivil.CASADO, new Endereco("Rua alagoas", "38408378", 12, "sem compl", "Martins", "Uberlandia", "MG"), "T123456", "MG123456", Sexo.FEMININO, Cargo.ESTAGIARIO, 4800.0, 2020, LocalDate.parse("2020-12-23"),true);
        ...
        try{
            contas[0].saque("a1234", -5.0); //TESTANDO A EXCESSAO!
